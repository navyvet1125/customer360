""" This file contains the views for the customer360 app. """
...
def index(request):
    """ This view returns the index page with all customers."""
    customers = Customer.objects.all()
    context = {"customers":customers}
    return render(request,"index.html",context=context)

def create_customer(request):
    """ This view creates a new customer."""
...
def summary(request):
    """ This view returns the summary page with all interactions."""
...
def interact(request,cid):
    """ This view creates a new interaction for a customer."""
